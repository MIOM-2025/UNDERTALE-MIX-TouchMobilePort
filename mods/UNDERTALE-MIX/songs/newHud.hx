...
function postCreate() {
	...
	// ======== 平滑血条绑定 ========
	bar = new FlxBar(0, 594, FlxBarFillDirection.RIGHT_TO_LEFT, 303, 25, wrapper, 'smoothedHealth', 0, maxHealth);
	bar.numDivisions = Std.int(bar.width / 2);
	// ============================
